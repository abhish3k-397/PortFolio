                                    ...
                                    <div className="relative overflow-hidden">
                                        ...
                                        {theme === 'cyberpunk' && (
                                            <div className="absolute inset-0 text-cyber-red opacity-70 animate-glitch-1 select-none pointer-events-none z-[-1]" aria-hidden="true">
                                                <h1 className="text-[clamp(2rem,8vw,7rem)] font-black tracking-tighter leading-[0.9] font-geek-trend glitch-skew origin-center">
                                                    ABHISHEK <br />
                                                    KRISHNA
                                                </h1>
                                            </div>
                                        ...
                                        {/* Main Visible Text */}
                                        <h1 className="hero-text-element text-[clamp(2rem,8vw,7rem)] font-black tracking-tighter leading-[0.9] cursor-default relative z-10 font-geek-trend glitch-skew origin-center">
                                            ABHISHEK <br />
