...
const Hero = () => {
    ...
    return (
        <section ref={containerRef} className="min-h-screen flex flex-col justify-center items-center relative overflow-hidden p-4">
            ...
            <div className="z-10 text-center max-w-5xl w-full pointer-events-none translate-x-0 md:-translate-x-8">
                                    ...
                                    <div className="relative overflow-hidden">
                                        ...
                                        {theme === 'cyberpunk' && (
                                            <div className="absolute inset-0 text-cyber-red opacity-70 animate-glitch-1 select-none pointer-events-none z-[-1]" aria-hidden="true">
                                                <h1 className="text-4xl md:text-8xl font-black tracking-tighter leading-[0.9] font-geek-trend glitch-skew origin-center">
                                                    ABHISHEK <br />
                                                    KRISHNA
                                                </h1>
                                            </div>
                                        ...
                                        {/* Main Visible Text */}
                                        <h1 className="hero-text-element text-4xl md:text-8xl font-black tracking-tighter leading-[0.9] cursor-default relative z-10 font-geek-trend glitch-skew origin-center">
                                            ABHISHEK <br />
