                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="relative overflow-hidden">
                                        ...
                                        {/* Main Visible Text */}
                                        <h1 className="hero-text-element text-[clamp(2rem,6vw,9rem)] font-black tracking-tighter leading-[1.2] md:leading-[0.9] cursor-default relative z-10 font-geek-trend glitch-skew origin-center text-cyan-400">
                                            ABHISHEK <br />
